...
import kz.telecom.core.core_application.BR
import kz.telecom.core.core_application.R
import kz.telecom.core.core_application.presentation.content.CoreButton
import kz.telecom.core.core_application.presentation.content.CoreMoneyEditText
import kz.telecom.core.core_application.presentation.content.CoreSimpleToolbar
import kz.telecom.core.core_application.presentation.content.CoreSpinner
import kz.telecom.core.core_application.presentation.ui.widget.toolbar.MainToolbar
...
fun Fragment.standardInitHomeToolbar(item: MainToolbar, view: View): ViewDataBinding? {
    val binding: ViewDataBinding? = DataBindingUtil.bind(view)
    binding?.setVariable(kz.telecom.core.core_application.BR.homeToolbar, item)
    binding?.root?.findViewById<ImageView>(kz.telecom.core.core_application.R.id.ic_back)?.setOnClickListener {
