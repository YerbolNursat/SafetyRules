package kz.dungeonmasters.core.core_application.utils.delegates

import android.util.Log
import android.view.View
import android.view.Window
import androidx.appcompat.app.AppCompatDelegate
import kz.dungeonmasters.core.core_application.data.constants.CoreConstant.MIN_VERSION_SUPPORT_DARK_MODE
import kz.dungeonmasters.core.core_application.data.constants.CoreVariables
import kz.dungeonmasters.core.core_application.data.prefs.SourcesLocalDataSource
import kz.dungeonmasters.core.core_application.utils.os.getOSVersion
...
class DarkThemeDelegate : DarkTheme, KoinComponent {
    ...
    override fun initTheme(window: Window, defaultTheme: Theme) {
        val theme = sourcesLocalStorage.getTheme(Theme.APP.name) ?: defaultTheme.name
    ...
    override fun setTheme(theme: Theme, window: Window) {
        ...
        makeTheme(sourcesLocalStorage.getTheme(Theme.APP.name), window)
    }

    override fun getUITheme(): Theme {
        return Theme.valueOf(sourcesLocalStorage.getTheme(Theme.APP.name).orEmpty())
    }
