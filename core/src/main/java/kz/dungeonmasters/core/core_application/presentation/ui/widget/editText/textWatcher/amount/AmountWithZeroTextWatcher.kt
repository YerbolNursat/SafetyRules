package kz.dungeonmasters.core.core_application.presentation.ui.widget.editText.textWatcher.amount

import android.text.Editable
import android.text.TextWatcher
import android.widget.EditText
import kz.dungeonmasters.core.core_application.data.constants.CorePatternConstant.PATTERN_FORMAT_ANOUNT_SPACE
import kz.dungeonmasters.core.core_application.data.constants.CorePatternConstant.PATTERN_FORMAT_ANOUNT_SPACE_ZERO
import kz.dungeonmasters.core.core_application.utils.delegates.AmountFormatSpaceWithoutZeroDelegate
import kz.dungeonmasters.core.core_application.utils.delegates.AmountFormatSpaceZeroDelegate
import kz.dungeonmasters.core.core_application.utils.delegates.AmountFormatter
...
class AmountWithZeroTextWatcher(
    ...
    private var amountFormatter: AmountFormatter? = when (pattern) {
        PATTERN_FORMAT_ANOUNT_SPACE_ZERO -> AmountFormatSpaceZeroDelegate()
        PATTERN_FORMAT_ANOUNT_SPACE -> AmountFormatSpaceWithoutZeroDelegate()
        else -> null
    }
