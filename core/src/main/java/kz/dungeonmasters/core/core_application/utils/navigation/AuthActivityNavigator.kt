package kz.dungeonmasters.core.core_application.utils.navigation
...
import kz.dungeonmasters.core.core_application.utils.extensions.showModuleActivity
...
class AuthActivityNavigator(
    ...
    override fun navigate(
        ...
        if (authToken.getAccessToken().isNullOrEmpty() && isAuthActivity) {
