...
import kz.dungeonmasters.home.presentation.ui.videos.VideosViewModel
...
val mainHomeViewModelModule = module {
    ...
    viewModel {
        TheoryViewModel(
            getTheoryUseCase = get(),
            getStaticFileUseCase = get(),
            getArticlesDetailUseCase = get()
        )
    }
    viewModel { PdfViewerViewModel() }
    viewModel { VideosViewModel(getVideosUseCase = get()) }
